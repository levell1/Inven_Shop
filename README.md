...
**문제점**  
INVEN창에 장비를 표시하는 부분에 아쉬운점이 있었고, shop을 시작할 때 문제를 느꼈고, Shop은 구현을 못하였습니다.  
Inven 부분의 UI 도 다 만들고나서 Scoll View 가 있다는 것을 알게 되어서 다음에 사용해 봐야겠습니다.

**궁금한 점**
> - Script를 나누는게 잘 되고 있는건지?  
> - json, SO 의 데이터구조, 방식이 잘 되고 있는건지?  
> - 아쉬운점, 더 좋은방법 에 대하여 알고싶습니다.  
